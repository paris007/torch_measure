...
def predict(input: dict, labeled: list[dict] | None = None) -> float:
    ...
    v10: v1/v2 routed baseline ensemble plus EB-shrunk residual offsets.
    Unlike `robust_ensemble`, this variant never directly blends toward the
    observed category label mean, which can overreact when K is only 5.
    """
    try:
