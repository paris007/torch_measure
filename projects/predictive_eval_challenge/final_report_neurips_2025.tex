...
\begin{flushleft}
The final project also includes reproducibility and safety infrastructure. The robustness tests check that each submission returns finite probabilities and handles malformed inputs. The submission builder creates flat Codabench ZIPs and avoids accidental overwrites unless forced. The local submission log tracks uploaded artifacts and scores, and Modal scripts were used for larger encoder, residual, and multi-seed experiments under the \texttt{pardis-stanford} workspace.
\end{flushleft}
